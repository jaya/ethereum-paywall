...
var _user$project$PurchaseInfo$PurchaseInfo = F2(
	function (a, b) {
...
var _user$project$Coin$purchaseCoins = _elm_lang$core$Native_Platform.outgoingPort(
	'purchaseCoins',
	function (v) {
...
var _user$project$Main$showUserAccount = function (model) {
	...
	if ((_p2.ctor === '_Tuple2') && (_p2._0.ctor === 'Just')) {
		...
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html$text('No account detected'),
				_1: {ctor: '[]'}
			});
	}
};
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Purchase coins!'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			});
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Coin blog'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
